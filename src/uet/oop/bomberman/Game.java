...
public class Game extends Canvas {
    ...
    public ImageIcon img = new ImageIcon("/icon/index.png");
    public static final String TITLE = "BombermanGame";
    public static SoundEffect soundEffect = new SoundEffect();
    private static final int BOMBRATE = 1;
    private static final int BOMBRADIUS = 1;
    private static final double BOMBERSPEED = 1.0;
    public static boolean[] kt = new boolean[5];
    public static final int TIME = 200;
    public static final int POINTS = 0;
    public static final int LIVES = 3;
    protected static Random random = new Random();
    static double _speed = (double)random.nextInt (200)/100;
    ...
    public Game(Frame frame) {
        ...
        _frame.setIconImage(img.getImage());
